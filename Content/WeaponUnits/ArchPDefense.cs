...
{
    public class ArchPDefenseUnit : BaseWeaponUnit
    {
        public override string InternalName => "ArchPDefense";
            ...
            else                   //½øÕ½×´Ì¬
            {
                ...
                if (target != -1)
                {
                    ...
                    if ((int)CurrentCooldown == 7)
                    {
                        ...
                        int protmp = DamageProj.Summon(ship.GetSource_FromAI(), TargetPos.Value, damage, crit, 0);
