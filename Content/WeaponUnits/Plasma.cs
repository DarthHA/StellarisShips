...
{
    public class PlasmaUnit : BaseWeaponUnit
    {
        public override string InternalName => "Plasma";
            ...
            else                   //½øÕ½×´Ì¬
            {
                ...
                if (target != -1)
                {
                    ...
                    if ((int)CurrentCooldown == 15)
                    {
                        ...
                        PlasmaBullet.Summon(ship.GetSource_FromAI(), shipNPC.GetPosOnShip(RelativePos), ShootVel, damage, color, scaleSlot, crit);
